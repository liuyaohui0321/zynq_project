...
fpga -file E:/zynq_project/axi_dma/axi_dma/axi_dma.sdk/system_wrapper_hw_platform_0/system_wrapper.bit
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Digilent JTAG-SMT2 C305A3E6ABCD"} -index 0
...
dow E:/zynq_project/axi_dma/axi_dma/axi_dma.sdk/axi_dma_bsp_xaxidma_example_simple_intr_1/Debug/axi_dma_bsp_xaxidma_example_simple_intr_1.elf
